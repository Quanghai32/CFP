...
namespace CFP_WPF
{
    public class clsTcpIpHandle
    {
            ...
            private void HandleSocketMsg()
            {
                ...
                while (true)
                {
                    ...
                    if (i != 0)
                    {
                        ...
                        //************TEMPORARY********************************************
                        //Call UserSocketServerHandle(strDataReceive, strDataServerRespond)
                        //strDataServerRespond = strDataReceive;
        ...
        /// <summary>
        /// ALL USER COMMAND PUT IN HERE
        /// </summary>
        /// <param name="strInServer"></param>
        /// <param name="strServerOut"></param>
        public static void UserSocketServerHandle(string strInServer, ref string strServerOut)
        {
        ...
        public string SocketServerStart()
        {
            ...
            try
            {
                HostlocalAddr = IPAddress.Parse(strHostIpAddr);
                this.serverSocket = null;
                this.clientSocket = null;
                this.serverSocket = new TcpListener(HostlocalAddr, HostPort);
                serverSocket.Start();
