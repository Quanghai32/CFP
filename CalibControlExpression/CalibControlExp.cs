...
namespace CalibControlExpression
{
    ...
    //            .Subscribe(ValueType =>
    //            {
    //                MessageBox.Show("This is reactive timer!");
    //            });
    //    }
    //}
    ...
    public class CalibControlExp : nspINTERFACE.IPluginExecute
    {
        ...
        public void IniSpecialControl()
        {
            ...
            //Function List
            lstSettingCommand.Add(new clsSettingForCommand("REACTIVECAL", 0, 0)); //1

            lstSettingCommand.Add(new clsSettingForCommand("NEWCAL", 0, 0)); //General Calibration Class
        }
        ...
        public object ExecuteSpecialFunction(clsCommonCommandGuider clsInput)
        {
            ...
            {
                case "REACTIVECAL":
                    return REACTIVECAL(clsInput);
                case "NEWCAL":
                    return cmdNEWCAL(clsInput);
                default:
        ...
        //*****************************************************************************************************************************
        public object REACTIVECAL(clsCommonCommandGuider clsInput) //Just create new class
        {
            Observable.Interval(TimeSpan.FromSeconds(5))
                .Subscribe(ValueType =>
                {
        ...
        //****************************************************************************************************************
        public object cmdNEWCAL(clsCommonCommandGuider clsInput) //Just create new class
        {
            //NEWCAL()

            //Create new general calibration class
            clsGeneralCalibration clsGeneralCal = new clsGeneralCalibration();

            //Initialization
            clsGeneralCal.IniGeneralCal();

            //Return class
            return clsGeneralCal;
        }
